...
function FindProxyForURL(url, host) {
  var privateIP =
    /^(0|10|100\.64|127|192\.168|172\.1[6789]|172\.2[0-9]|172\.3[01]|169\.254|192\.88\.99|161\.89|161\.90|156\.150|198\.148\.129|138\.69\.223)\.[0-9.]+$/;
  ...
  if (shExpMatch(host, "10.204.*")) {
    if (shExpMatch(host, "10.204.33.161")) {
      return "PROXY 161.89.192.10:3128";
    }
    if (shExpMatch(host, "10.204.33.163")) {
      return "PROXY 161.89.192.10:3128";
    }
    if (shExpMatch(host, "10.204.65.161")) {
      return "PROXY 161.89.194.10:3128";
    }
    if (shExpMatch(host, "10.204.33.162")) {
      return "PROXY 161.89.192.11:3128";
    }
    if (shExpMatch(host, "10.204.33.165")) {
      return "PROXY 161.89.192.11:3128";
    }
    if (shExpMatch(host, "10.204.65.162")) {
      return "PROXY 161.89.194.11:3128";
    }
  }

  //to VZEN : proxy-vzen.myatos.net
  if (
    shExpMatch(host, "*.mev.atos.net") ||
  ...
  /* Bypass Zscaler */
  if (
    dnsDomainIs(host, "pilot-ura.it-solutions.atos.net") ||
  ...
  if (
    shExpMatch(host, "atos.voipex.io") ||
...
function getProxyForUrl(url, host) {
...
console.log("[localproxy]: getProxyForUrl:", getProxyForUrl(url, host));
